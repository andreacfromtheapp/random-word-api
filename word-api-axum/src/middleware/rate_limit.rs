...
mod tests {
    ...
    fn test_rate_limiting_enabled() {
        ...
        config.security_limits.rate_limit_per_second = 5;
    ...
    fn test_get_per_second() {
        let mut config = ApiConfig::default();
        config.security_limits.rate_limit_per_second = 10;
    ...
    fn test_get_burst_size() {
        let mut config = ApiConfig::default();
        config.security_limits.rate_limit_per_second = 3;
